...
function rowClassOf(item){
  ...
  if (stage === 'running') classes.push('content-row-running')
  if (stage === 'uploaded') classes.push('content-row-uploaded')
  if (Number(item?.emergency)===1) classes.push('content-row-emergency')
  return classes.join(' ')
}
