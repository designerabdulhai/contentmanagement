...
export default function Dashboard(){
 ...
 const stats=[{key:'total',label:'Total posts',value:posts.length,icon:'📁',trend:''},{key:'scheduledMonth',label:'Scheduled this month',value:scheduledThisMonth.length,icon:'🗓️',trend:''},{key:'uploadedMonth',label:'Uploaded this month',value:uploadedThisMonth.length,icon:'⬆️',trend:''},{key:'listedMonth',label:'Listed this month',value:listedThisMonth.length,icon:'📝',trend:''}];
